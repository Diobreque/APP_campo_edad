...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_STUDENTS = "CREATE TABLE "
            + TABLE_USER + "(" + KEY_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_FIRSTNAME + " TEXT, "+ KEY_HOBBY + " TEXT, "+ KEY_EDAD + " TEXT);";
    ...
    public long addUserDetail(String name, String hobby, String edad) {
        SQLiteDatabase db = this.getWritableDatabase();
        // Creating content values
        ContentValues values = new ContentValues();
        values.put(KEY_FIRSTNAME, name);
        values.put(KEY_HOBBY, hobby);
        values.put(KEY_EDAD, edad);
    ...
    public ArrayList<UserModel> getAllUsers() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                userModel.setEdad(c.getString(c.getColumnIndex(KEY_EDAD)));
    ...
    public int updateUser(int id, String name, String hobby, String edad) {
        SQLiteDatabase db = this.getWritableDatabase();
